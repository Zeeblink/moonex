  ...
  return (
    <div className="min-h-[850px] mb-0 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[170px] left-[10%] w-[61px] h-[60px] scale-75 animate-twinkle">
          <Star />
        </div>
        ...
        <div className="absolute top-[500px] right-[10%] w-[61px] h-[60px] scale-75 animate-twinkle">
          <Star />
        </div>
      </div>
